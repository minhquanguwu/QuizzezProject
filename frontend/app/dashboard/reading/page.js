...
export default function StudyPage() {
    ...
    return (
        <div className="flex h-screen flex-col bg-[#F2F2F2]">
            <div className="flex flex-wrap space-x-2 flex-row justify-center gap-6 mt-8 max-h-screen ">
                <Card
                    className="pb-4 mb-10 py-3 "
                    isPressable
                    onClick={() => router.push("/readbook/")}
                >
                    ...
                    <CardBody className="overflow-visible py-2 flex flex-col h-96 justify-between">
                        <Image
                            alt="Card background"
