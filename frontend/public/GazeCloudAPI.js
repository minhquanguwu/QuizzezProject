...
var GazeCloudAPI = new (function GazeCloudAPIInit() {
        ...
        if (ServerUrl != "") {
            ...
            if (!GetCloudAdressReady) {
                _WaitForGetCloudAdress = setInterval(() => {
                    ...
                    if (!GetCloudAdressReady) if (Logg) Logg("GetCloudAdress too long", 2);
                    StartGazeFlow();
                }, 2000);
            } else {
                StartGazeFlow();
    ...
    var rrwebRecord = (function () {
                ...
                m = (function (t, n, r, o, a) {
                    switch (t.nodeType) {
                        ...
                        case t.ELEMENT_NODE:
                            ...
                            if ("link" === c && o) {
                                var y,
                                    g = Array.from(n.styleSheets).find(function (e) {
                                        return e.href === t.href;
                                    });
                                (y = i(g)) &&
                                    (delete s.rel, delete s.href, (s._cssText = l(y, g.href)));
                            }
                            if (
                                ("style" === c &&
                                    t.sheet &&
                        ...
                        case t.TEXT_NODE:
                            var N = t.parentNode && t.parentNode.tagName,
                                ...
                                I = "STYLE" === N || void 0;
                            return (
                                I && T && (T = l(T, location.href)),
                                "SCRIPT" === N && (T = "SCRIPT_PLACEHOLDER"),
                                { type: e.Text, textContent: T || "", isStyle: I }
                            );
        ...
        function k(e, t, r, o) {
            var a = new MutationObserver(function (a) {
                ...
                a.forEach(function (e) {
                    ...
                    switch (n) {
                        ...
                        case "attributes":
                            ...
                            s || ((s = { node: r, attributes: {} }), d.push(s)),
                                (s.attributes[u] = f(document, u, c));
                            break;
                        case "childList":
                            a.forEach(function (e) {
                                return C(e, r);
                ...
                (R.texts.length || R.attributes.length || R.removes.length || R.adds.length) &&
                    e(R);
            });
            return (
                a.observe(document, {
            ...
            function i(e) {
                ...
                if (t && t.tagName && !(O.indexOf(t.tagName) < 0) && !N(t, n)) {
                    ...
                    if ("password" !== o && !t.classList.contains(r)) {
                        ...
                        "radio" === o || "checkbox" === o
                            ? (c = t.checked)
                            : s && a && (i = "*".repeat(i.length)),
                            u(t, { text: i, isChecked: c });
                        var l = t.name;
                        "radio" === o &&
                            l &&
                            c &&
                    ...
                    (c = E(
                        function (e) {
                            var t = e.target,
                                ...
                                o = n.clientY;
                            a || (a = Date.now()),
                                i.push({ x: r, y: o, id: b.getId(t), timeOffset: Date.now() - a }),
                                u(T(e));
                        },
                        r,
                        { trailing: !1 }
                            ...
                            F(
                                {
                                    ...
                                    mouseInteractionCb: function (e) {
                                        return _(
                                            P({
                                                type: h.IncrementalSnapshot,
                                                data: t({ source: v.MouseInteraction }, e),
                                            })
                                        );
                                    },
                                    scrollCb: function (e) {
                                    ...
                                    viewportResizeCb: function (e) {
                                        return _(
                                            P({
                                                type: h.IncrementalSnapshot,
                                                data: t({ source: v.ViewportResize }, e),
                                            })
                                        );
                                    },
                                    inputCb: function (e) {
        ...
        try {
            if (eventsWebRec.length > WebRecIx) {
                ...
                while (WebRecIx < ll) {
                    ...
                    WebEventStringStream += compres;
                    WebRecIx++;
                    if (!bend) if (SendTxt.length > 1000) break;
                }
                SendTxt = "we:" + SendTxt;
                ws.send(SendTxt);
                if (false) {
    ...
    function doKeyDown(e) {
        // alert( "doKeyDown"   );
        if (e.keyCode == 27) if (bIsRunCalibration) FinishCalibration();
    }
    //===========================================
    ...
    function AbortCalibration() {
        ...
        closeFullscreen();
        if (false) if (GazeCloudAPI.OnCalibrationFail != null) GazeCloudAPI.OnCalibrationFail();
    ...
    function FinishCalibration() {
        ...
        if (true) {
            // update gui
            camid.style =
                " z-index: 1000;position:absolute; left:0%; top:0%; opacity: 0.7; display:none ";
    ...
    function ShowCalibration() {
        ...
        if (GazeCloudAPI.oFullScreen) openFullscreen(etmp);
    ...
    function _ShowCalibration() {
        if (true) {
            // update gui
            camid.style =
                " z-index: 1000;position:fixed; left:0%; top:0%; opacity: 0.7; display:none ";
        }
        ...
        _LoopCalibration = setInterval(() => {
            ...
            try {
                if (Ix > -1) if (vPoints[Ix].color == "play") showtime *= 1.5;
    ...
    function isFullscreen() {
        ...
        return (
            window.fullScreen == true || screen.height - document.documentElement.clientHeight <= 30
        );
    }
    //------------------------------
    ...
    function getGrayFrameROIResize(_video, GazeD, bOnlyEyes = false, quality = 0.9) {
        try {
            if (_canvas == null) {
            ...
            quality = 0.9;
            // quality = .97;
            if (true) if (GazeD.state == -1) quality = 0.8;
            //   quality = .92;
    ...
    function CamSendLoop() {
        ...
        if (true) {
            ...
            if (false)
                if (FrameCountDelay > 4) {
                    ...
                    if (
                        networkDelay < minNetworkDelay * 1.2 ||
                        networkDelay < 0.3 * avrNetworkDelay
                    )
                        waitT = _CamLoopInterval;
                }
            if (waitT < 0.8 * LastWaitT) waitT = 0.8 * LastWaitT;
            //
            waitT = 30;
            if (true) {
        ...
        if (bSend) {
            ...
            if (CurCalPoint != null) {
                ...
                ws.send(json_data);
                if (CurCalPoint.type == 10)
                    // reset cur click point
                    CurCalPoint = null;
            } //////end cal point///////
            FrameTime = Date.now();
        ...
        if (bNewVideoGrap) {
            ...
            if (_GazeData.state != -1)
                if (!bGazeCloundLowFpsSend) {
                    ...
                    if (CurFrameNr > 100) {
                        var s = 1;
                        if (!bSend) s = 0;
                        SkipFactor = 0.95 * SkipFactor + s * 0.05;
                    }
                }
            var FrameCountDelay = CurFrameNr - CurFrameReciveNr;
            ...
            waitT = _CamLoopInterval;
            waitT -= processDelay;
            if (false) if (FrameCountDelay > 4) waitT += ((FrameCountDelay - 4) / 10.0) * 100.0;
            if (waitT < 5) waitT = 5;
            // setTimeout(CamSendLoop, waitT);
        }
        if (bSend) {
            var dd = (FrameCountDelay - BuforMaxC * 0.7) / BuforMaxC;
            if (dd < 0) dd = 0;
            var ww = 30 + 30 * dd;
            setTimeout(function () {
                requestAnimationFrame(CamSendLoop);
        ...
        if (false) {
            ...
            if (ZoomCanvasCtx)
                ...
                ZoomCanvasCtx.drawImage(
                    videoOrginal,
                    (videoOrginal.videoWidth - ZoomCanvas.width) / 2,
                    (videoOrginal.videoHeight - ZoomCanvas.height) / 2,
                    ZoomCanvas.width,
                    ZoomCanvas.height,
                    0,
                    0,
        ...
        if (navigator.mediaDevices.getUserMedia === undefined) {
            navigator.mediaDevices.getUserMedia = function (constraints) {
                ...
                if (!getUserMedia) {
                    ...
                    alert(
                        "Camera access is not supported by this browser! Try: Chrome 53+ | Edge 12+ | Firefox 42+ | Opera 40+ | Safari 11+  "
                    );
    ...
    function deniedStream(err) {
        ...
        else alert("Camera access denied! Please, Allow Camera Access to start Eye-Tracking");
        ...
        isWaitForAutoryzation = setTimeout(function () {
            ...
            if (!ConnectionOk) {
                ...
                if (true) {
                    ...
                    if (RedirectPort > GazeCloudServerPort + 4)
                        RedirectPort = GazeCloudServerPort + 1;
        ...
        ///////gaze data//////////
        {
            ...
            if (evt.data.substring(2, 7) == "AckNr") {
                ...
                if (networkDelay < 10 * minNetworkDelay)
                    avrNetworkDelay =
                        (avrNetworkDelay * ack.AckNr + networkDelay) / (ack.AckNr + 1);
            ...
            if (evt.data.substring(0, 4) == "Cal:") {
                ...
                if (evt.data.substring(4, 6) == "no") {
                    ...
                    else ShowErr("Invalid Calibration!");
                }
                return;
            }
            ...
            try {
                ...
                if (!isNaN(skipC)) if (skipC > 0) skipProcessCount += skipC;
    ...
    function Connect(_url = "") {
        try {
            ...
            AppKey = "AppKeyDemo";
            if (GazeCloudAPI.APIKey) AppKey = GazeCloudAPI.APIKey;
            ConnectionOk = false;
                ...
                ws.onerror = function (error) {
                    ...
                    if (!ConnectionOk)
                        if (ConnectCount < 3) {
                            ...
                            console.log(
                                "ws.onerror  ConnectCount try again" + ConnectCount + "url " + _url
                            );
                            Connect(_url);
                        } else {
                            GetCloudAdressReconnect();
    ...
    function PlotGazeData(GazeData) {
        ...
        avrDelay = 0.99 * avrDelay + 0.01 * delay;
        ...
        var y =
            GazeData.GazeY -
            window.screenY -
            (window.outerHeight - (window.innerHeight * window.devicePixelRatio) / CalDeviceRation);
        ...
        if (true) {
            ...
            if (x < 0 && x > -_m) x = 0.2 * x; //;x = 0;
            if (y < 0 && y > -_m) y = 0.2 * y; //y = 0;
            var _w = window.innerWidth;
            var _h = window.innerHeight;
            if (x > _w && x - _w < _m) x = 0.2 * x + 0.8 * _w; //  x = _w;
            if (y > _h && y - _h < _m)
                //y = _h;
                y = 0.2 * y + 0.8 * _h; //  x = _w;
        }
        ...
        if (typeof heatmap !== "undefined")
            if (heatmap != null)
                if (!bIsRunCalibration && !bIsProcesingCalibration && bIsCalibrated) {
                    if (GazeData.state == 0) {
                        var Precision = 1; //5;
                        var _x = Math.round(x / Precision) * Precision + (0.5 * Precision - 0.5);
                        var _y = Math.round(y / Precision) * Precision + (0.5 * Precision - 0.5);
                        _x = Math.round(_x);
                        _y = Math.round(_y);
    ...
    function UpdateGUI(GazeData) {
        ...
        try {
            ...
            if (
                TrackingLostShow ||
                (!bIsCalibrated && !bIsProcesingCalibration && !bIsRunCalibration)
            )
                display = "block";
            else display = "none";
    ...
    function StartGazeFlow() {
        ...
        if (true) {
            ...
            camid.style =
                " z-index: 1000;position:absolute; left:50%; top:2%  ; margin-left: -160px; ";
            camid.style.marginLeft = -camid.scrollWidth / 2;
        }
        GazeResultEvents = [];
        try {
...
function InitOldAPI() {
    try {
        ...
        if (typeof OnCalibrationComplete !== "undefined")
            GazeCloudAPI.OnCalibrationComplete = OnCalibrationComplete;
        if (typeof OnCalibrationFail !== "undefined")
            GazeCloudAPI.OnCalibrationFail = OnCalibrationFail;
